...
function JoinPage() {
  ...
  function submit(event: FormEvent) {
    ...
    if (!isValidQuestionCode(code)) { setError('Use #S#Q##: the first character may be A–Z or 0–9, and the remaining # characters are digits (for example, AS1Q02).'); return }
